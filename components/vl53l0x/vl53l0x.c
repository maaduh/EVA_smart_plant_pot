...
#define TIMEOUT	(1000/portTICK_PERIOD_MS) // I2C command timeout - increased to 1000ms for reliable operation
...
vl53l0x_config (int8_t port, int8_t scl, int8_t sda, int8_t xshut, uint8_t address, uint8_t io_2v8)
{
   ...
   // I2C driver is already installed globally in app_main, skip installation
   // Just configure timeout and filter
